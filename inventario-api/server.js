...
const runMigrations = async () => {
    ...
    try {
        ...
        const migrations = [
            ...
            { // Migration 23: Re-run adding 'brand' column to fix schema mismatches
                id: 23, sql: `ALTER TABLE equipment ADD COLUMN brand VARCHAR(255) NULL;`
            },
            { // Migration 24: Re-run adding 'model' column to fix schema mismatches
                id: 24, sql: `ALTER TABLE equipment ADD COLUMN model VARCHAR(255) NULL;`
            }
        ];
...
app.post('/api/licenses/import', isAdmin, async (req